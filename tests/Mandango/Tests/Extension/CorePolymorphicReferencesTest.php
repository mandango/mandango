...
class CorePolymorphicReferencesTest extends TestCase
{
    public function testDocumentReferencesOneSetterGetter()
    {
        ...
        $category = $this->mandango->createDocument('Model\Category')->setName('foo')->save();
    ...
    {
        $this->mandango->createDocument('Model\Article')->setLike(new \DateTime());
    }

    public function testDocumentUpdateReferenceFieldsReferencesOne()
    {
        $author = $this->mandango->createDocument('Model\Author');
        $article = $this->mandango->createDocument('Model\Article')->setLike($author);
    ...
    {
        $author = $this->mandango->createDocument('Model\Author');
        $article = $this->mandango->createDocument('Model\Article')->setFriend($author);
        $author->setId(new \MongoId('123'));
        $article->updateReferenceFields();
        $this->assertSame(array(
            'name' => 'au',
    ...
    {
        $author = $this->mandango->createDocument('Model\Author')->setName('pablodip')->save();
        $article = $this->mandango->createDocument('Model\Article')->setLike($author);
    ...
    public function testDocumentUpdateReferenceFieldsReferencesManyNew()
    {
        $article = $this->mandango->createDocument('Model\Article');
        $related = $article->getRelated();
        $author1 = $this->mandango->createDocument('Model\Author')->setId(new \MongoId('1'));
        $author2 = $this->mandango->createDocument('Model\Author')->setId(new \MongoId('2'));
        $category1 = $this->mandango->createDocument('Model\Category')->setId(new \MongoId('3'));
        $user1 = $this->mandango->createDocument('Model\User')->setId(new \MongoId('4'));
    ...
    public function testDocumentUpdateReferenceFieldsReferencesManyNotNew()
    {
        ...
        $related = $article->getRelated();
        $add = array();
        $related->add($add[] = $this->mandango->createDocument('Model\User')->setId(new \MongoId('1')));
        $related->add($add[] = $this->mandango->createDocument('Model\Author')->setId(new \MongoId('5')));
        $related->add($add[] = $this->mandango->createDocument('Model\Author')->setId(new \MongoId('6')));
        $related->remove($this->mandango->createDocument('Model\Author')->setId($relatedRef[1]['id']));
        $related->remove($this->mandango->createDocument('Model\Category')->setId($relatedRef[3]['id']));
    ...
    public function testDocumentUpdateReferenceFieldsReferencesManyNewDiscriminatorMap()
    {
        ...
        $element1 = $this->mandango->createDocument('Model\FormElement')->setId(new \MongoId('1'));
        $element2 = $this->mandango->createDocument('Model\FormElement')->setId(new \MongoId('2'));
        $textareaElement1 = $this->mandango->createDocument('Model\TextareaFormElement')->setId(new \MongoId('3'));
        $radioElement1 = $this->mandango->createDocument('Model\RadioFormElement')->setId(new \MongoId('4'));
    ...
    public function testDocumentUpdateReferenceFieldsReferencesManyNotNewDiscriminatorMap()
    {
        ...
        $elements = $article->getElements();
        $add = array();
        $elements->add($add[] = $this->mandango->createDocument('Model\RadioFormElement')->setId(new \MongoId('1')));
        $elements->add($add[] = $this->mandango->createDocument('Model\FormElement')->setId(new \MongoId('5')));
        $elements->add($add[] = $this->mandango->createDocument('Model\FormElement')->setId(new \MongoId('6')));
        $elements->remove($this->mandango->createDocument('Model\FormElement')->setId($elementsRef[1]['id']));
        $elements->remove($this->mandango->createDocument('Model\TextareaFormElement')->setId($elementsRef[3]['id']));
    ...
    public function testReferencesManyQuery()
    {
        ...
        $users = array();
        for ($i = 0; $i < 9; $i++) {
            $users[] = $this->mandango->createDocument('Model\User')->setUsername('User'.$i)->save();
        }
        ...
        $article = $this->mandango->createDocument('Model\Article')->setRelatedRef($relatedRef);
        $this->assertSame(array(
            $authors[3],
            $authors[5],
            $categories[1],
    ...
    public function testReferencesManyQueryDiscriminatorMap()
    {
        $elements = array();
        for ($i = 0; $i < 9; $i++) {
            $elements[] = $this->mandango->createDocument('Model\FormElement')->setLabel('Element'.$i)->save();
        }
        $textareaElements = array();
        for ($i = 0; $i < 9; $i++) {
            $textareaElements[] = $this->mandango->createDocument('Model\TextareaFormElement')->setLabel('Textarea'.$i)->save();
        }
        $radioElements = array();
        for ($i = 0; $i < 9; $i++) {
            $radioElements[] = $this->mandango->createDocument('Model\RadioFormElement')->setLabel('Radio'.$i)->save();
        }
        ...
        $article = $this->mandango->createDocument('Model\Article')->setElementsRef($elementsRef);
        $this->assertSame(array(
            $elements[3],
            $elements[5],
            $textareaElements[1],
    ...
    public function testDocumentQueryForSaveReferencesMany()
    {
        ...
        $related = $article->getRelated();
        $author = $this->mandango->createDocument('Model\Author')->setName('foo')->save();
        $category = $this->mandango->createDocument('Model\Category')->setName('bar')->save();
    ...
    {
        $element = $this->mandango->createDocument('Model\FormElement')->setLabel('foo');
        $this->assertSame(array(
            'label' => 'foo',
        ...
        $textareaElement = $this->mandango->createDocument('Model\TextareaFormElement')->setLabel('ups');
        $this->assertSame(array(
            'type' => 'textarea',
            'label' => 'ups',
